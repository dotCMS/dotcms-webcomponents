...
var dotCheckboxCss = ".dot-checkbox__items{display:-ms-flexbox;display:flex;-ms-flex-direction:column;flex-direction:column}.dot-checkbox__items label{display:-ms-flexbox;display:flex;-ms-flex-align:center;align-items:center}.dot-checkbox__items input{margin:0 0.25rem 0 0}";
var DotCheckboxComponent = /** @class */ (function () {
    ...
    class_1.prototype.render = function () {
        ...
        return (h(Host, { class: Object.assign({}, classes) }, h("dot-label", { label: this.label, required: this.required, name: this.name }, h("div", { "aria-describedby": getHintId(this.hint), tabIndex: this.hint ? 0 : null, class: "dot-checkbox__items" }, this._options.map(function (item) {
    ...
    class_1.prototype.getValueFromCheckInputs = function (value, checked) {
