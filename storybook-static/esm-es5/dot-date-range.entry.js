...
import { g as getOriginalStatus, k as getId, b as getTagError, c as getTagHint, h as getHintId, j as getErrorClass, a as getClassNames, u as updateStatus } from './utils-4c5e19e6.js';
...
var DotDateRangeComponent = /** @class */ (function () {
    ...
    class_1.prototype.valueWatch = function () {
        var dates = checkProp(this, 'value', 'dateRange');
        if (dates) {
            var _e = dates.split(','), startDate = _e[0], endDate = _e[1];
            this.flatpickr.setDate([this.parseDate(startDate), this.parseDate(endDate)], false);
        }
    };
    class_1.prototype.presetsWatch = function () {
    ...
    class_1.prototype.setPreset = function (event) {
        var dateRange = [];
        var dt = new Date();
    ...
    class_1.prototype.isDateRangeValid = function (selectedDates) {
        return selectedDates && selectedDates.length === 2;
    };
    class_1.prototype.setValue = function (selectedDates, _dateStr, _instance) {
...
DotDateRangeComponent.style = dotDateRangeCss;
