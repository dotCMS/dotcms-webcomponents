...
const DotDateRangeComponent = class {
    ...
    valueWatch() {
        const dates = checkProp.checkProp(this, 'value', 'dateRange');
        if (dates) {
    ...
    componentDidLoad() {
        this.flatpickr = flatpickr(`#${utils.getId(this.name)}`, {
            mode: 'range',
    ...
    render() {
        return (index.h(index.Host, { class: Object.assign({}, utils.getClassNames(this.status, this.isValid(), this.required)) }, index.h("dot-label", { label: this.label, required: this.required, name: this.name }, index.h("div", { "aria-describedby": utils.getHintId(this.hint), tabIndex: this.hint ? 0 : null, class: "dot-range__body" }, index.h("input", { class: utils.getErrorClass(this.status.dotValid), disabled: this.isDisabled(), id: utils.getId(this.name), required: this.required || null, type: "text", value: this.value }), index.h("label", null, this.presetLabel, index.h("select", { disabled: this.isDisabled(), onChange: this.setPreset.bind(this) }, this.presets.map((item) => {
            return index.h("option", { value: item.days }, item.label);
...
exports.dot_date_range = DotDateRangeComponent;
