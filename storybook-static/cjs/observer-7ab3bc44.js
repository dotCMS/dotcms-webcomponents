...
function findAssignedElement(slot, selector) {
    for (const node of slot.assignedNodes({ flatten: true })) {
        if (isNodeElement(node)) {
            const el = node;
            if (foundation.matches(el, selector)) {
                return el;
            }
        }
    }
...
*/
/** @soyCompatible */
class BaseElement extends litElement.LitElement {
    /**
 ...
 */
const classMap = litElement.directive((classInfo) => (part) => {
    if (!(part instanceof litElement.AttributePart) || (part instanceof litElement.PropertyPart) ||
 ...
 */
const styleMap = litElement.directive((styleInfo) => (part) => {
    if (!(part instanceof litElement.AttributePart) || (part instanceof litElement.PropertyPart) ||
...
class RippleBase extends BaseElement {
    constructor() {
        ...
        this.leftPos = '';
        this.topPos = '';
        this.mdcFoundationClass = foundation.MDCRippleFoundation;
    }
    get isActive() {
...
litElement.__decorate([
    litElement.query('.mdc-ripple-surface')
...
Ripple.styles = style;
Ripple = litElement.__decorate([
    litElement.customElement('mwc-ripple')
], Ripple);
