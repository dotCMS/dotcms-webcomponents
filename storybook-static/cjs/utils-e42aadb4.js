...
function getTagError(show, message) {
    return show && isStringType(message) ? (index.h("span", { class: "dot-field__error-message" }, message)) : null;
}
/**
...
function getTagHint(hint) {
    return isStringType(hint) ? (index.h("span", { class: "dot-field__hint", id: getHintId(hint) }, hint)) : null;
}
/**
...
exports.getDotOptionsFromFieldValue = getDotOptionsFromFieldValue;
exports.getErrorClass = getErrorClass;
exports.getHintId = getHintId;
exports.getId = getId;
exports.getLabelId = getLabelId;
exports.getOriginalStatus = getOriginalStatus;
exports.getStringFromDotKeyArray = getStringFromDotKeyArray;
exports.getTagError = getTagError;
exports.getTagHint = getTagHint;
