...
export const getElement = (content) => {
...
export const getPositionX = ({ tooltipEl: tooltip, targetEl: target, position }) => {
...
export const getPositionY = ({ tooltipEl: tooltip, targetEl: target, position }) => {
