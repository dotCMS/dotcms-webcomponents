...
export class DotDateComponent {
    ...
    static get properties() { return {
        "value": {
            ...
            "docs": {
                "tags": [],
                "text": "Value format yyyy-mm-dd  e.g., 2005-12-01"
            },
            "attribute": "value",
            "reflect": true,
            "defaultValue": "''"
        ...
        "min": {
            ...
            "docs": {
                "tags": [],
                "text": "(optional) Min, minimum value that the field will allow to set. Format should be yyyy-mm-dd"
            },
            "attribute": "min",
            "reflect": true,
            "defaultValue": "''"
        ...
        "max": {
            ...
            "docs": {
                "tags": [],
                "text": "(optional) Max, maximum value that the field will allow to set. Format should be yyyy-mm-dd"
            },
            "attribute": "max",
            "reflect": true,
            "defaultValue": "''"
